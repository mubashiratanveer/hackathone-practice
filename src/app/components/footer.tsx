...
export default function Footer(){
    return(
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-10 py-8">
        <div>
          <h4 className="text-lg font-semibold mb-6 text-white">Exculsive</h4>
          <p className="text-gray-400 text-base">subscribe</p>
          <p className="text-gray-400 text-base" >Get 10% off of your first order</p>
             <input type="text" name="" id="email" placeholder="Enter your email"  className="mt-7 bg-gray-300 p-2 text-gray-400"/>
        </div>

        <div>
          <h4 className="text-lg font-semibold mb-6 text-white">Support</h4>
          <ul className="space-y-4">
            <li><a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base">111 Bijoy sarani, Dhaka,  DH 1515, Bangladesh.</a></li>
            <li><a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base">exclusive@gmail.com</a>
            </li>
            <li><a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base">+88015-88888-9999</a></li>
          </ul>
        </div>

        <div className="space-y-4">
          <h4 className="text-lg font-semibold mb-6 text-white">Account</h4>
      ...
      <div className="bg-black p-5 mt-12">
        <p className='text-gray-400 text-base text-center'>© copyright Rimel 2022.All right reserved.</p>
      </div>
